...
!******* SACAR ****************************************************************
!       write(330,1777)real(epsi(s)),(T_LD(1,j),j=dec_number-30,dec_number)
!       write(331,1777)real(epsi(s)),(T_DD(1,j),j=dec_number-30,dec_number)
!       write(332,1777)real(epsi(s)),T_LL(1,2)
!	write(340,1777)real(epsi(s)),T_LL(1,1)+T_LL(1,2)
!	write(341,1777)real(epsi(s)),T_LL(1,1)+T_LL(1,2)+sum(T_LD(1,:))
	write(350,1777)real(epsi(s)),T_LL(1,1)+1.d0,(T_DD(j,j)+1.d0,j=1,30)
	if (s .eq. 30) stop
!******* SACAR ****************************************************************
       ...
       write(77,1777)real(epsi(s)),T_ef(1,2),1+t_ef(1,1),T_ef(2,1),1+t_ef(2,2)
